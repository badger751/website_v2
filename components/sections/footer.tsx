...
export default function Footer(){
  ...
  <nav>
    ...
    <div className="grid grid-flow-col gap-4">
      <a  href="https://x.com/srsamacharin" >
        <svg
      ...
      <a href = "https://youtube.com/@srsamacharofficial?si=t-dkxmntBcKS4od0" >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
      ...
      <a href = "https://www.facebook.com/share/v/19H7gkn5Kn/" >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
  ...
  <aside>
    <p>Copyright © {new Date().getFullYear()} - All right reserved by SR samachar</p>
  </aside>
</footer>
</footer>
